...
- `folloze-campaign-board-builder` - customer-facing marketer workflow from campaign brief to approved wireframe, local editable HTML, automatic QA, and Folloze publish readiness
